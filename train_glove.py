...
model = tf.keras.Sequential([
    layers.Embedding(vocab_size, word_length, weights=[embedding_matrix], input_length=max_length,
                     trainable=False),
...
save_model_to_json(model, './results/neural_network_glove')

with open('results/glove.data', 'wb') as file:
